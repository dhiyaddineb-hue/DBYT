...
> **إصدار Notebook: `2026.08.21-05`** — افتح هذه النسخة ولا تستخدم نسخة أقدم محفوظة في Colab.
...
code("""#@title 1) تثبيت الأدوات الأساسية — DBYT Notebook v2026.08.21-05
NOTEBOOK_VERSION = '2026.08.21-05'
